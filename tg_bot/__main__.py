...
👏 HEY {} \n\n🔥 My Name Is {}! \n\n😏 [Smile In Pain](https://telegra.ph/file/6824a00f2babc136862cd.jpg)\n\n😝 വേറെ ഒന്നും നോക്കണ്ട എന്നെ [𝗠𝗛𝗗_𝗧𝗛𝗔𝗡𝗭𝗘𝗘𝗥](tg://user?id={}) മാത്രമേ ഉപയോഗിക്കാൻ കഴിയുകയുള്ളൂ... 😏
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🌀 Let's Beginning To Roll 💝", url="t.me/{}?startgroup=true".format(bot.username)) ]]))
    else:
